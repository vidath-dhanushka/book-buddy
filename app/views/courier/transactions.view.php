                ...
                <div class="page-contents">
                    <main class="table">
                        <section class="table__header">
                            <h1 style="padding-top: 5px; text-align:center">Ongoing Orders</h1>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th> Payment method <span class="icon-arrow">&UpArrow;</span></th>
                                        <th> Amount(Rs.) <span class="icon-arrow">&UpArrow;</span></th>
                                        <th>Payment Date<span class="icon-arrow">&UpArrow;</span></th>
                                        <!-- <th>Order Status</th> -->
                                    </tr>
                                </thead>
                                <tbody>
