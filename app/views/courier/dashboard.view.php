...
<body>
    ...
    <section class="home-section">
        ...
        <div class="cardBox  col-6" style="display: flex; align-items:center; justify-content:center;">


            <a href="<?= ROOT ?>/courier/ongoing" style="color:black;">
                <div class="card" style="width: 200px; height:300px; justify-content:center">
                    <div>
                        <h1>Orders</h1>
                        <div class="iconBx">
            ...
            <a href="<?= ROOT ?>/courier/completed" style="color:black;">
                <div class="card" style="width: 200px; height:300px; justify-content:center">
                    <div>
                        <h1>Orders</h1>
                        <div class="iconBx">
            ...
            <a href="<?= ROOT ?>/courier/transactions" style="color:black;">
                <div class="card" style="width: 200px; height:300px; justify-content:center">
                    <div>
                        <h1>monthly</h1>
                        <div class="iconBx">
                        ...
                        <br>
                        <div class="numbers" style="font-size:20px;">Rs. 6000.00/=</div>
                        <div class="cardName">
                            Earnings
                        </div>
                    </div>
